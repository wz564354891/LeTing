...
import UIKit
import WebKit
class YIWenViewController: UIViewController,WKNavigationDelegate,WKUIDelegate{
   // var url = "http://wawa.fm/webview/list.html?uid=0&id=29"
    var url = "http://wawa.fm/webview/list.html?uid=46018&id=29"
