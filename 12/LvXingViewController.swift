...
import UIKit
import WebKit
class LvXingViewController: UIViewController,WKNavigationDelegate,WKUIDelegate {
  var url = "http://wawa.fm/webview/list.html?uid=46018&id=653"
