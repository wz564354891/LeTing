...
import UIKit
import WebKit
class YingYongViewController: UIViewController,WKNavigationDelegate,WKUIDelegate {
    var url = "http://wawa.fm/webview/list.html?uid=46018&id=30"
